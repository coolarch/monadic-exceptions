...
public class ThrowableToDoubleFunctionTest extends
	AbstractLambdaTest<ThrowableToDoubleFunction<String>, ToDoubleFunction<String>> {

	@SuppressWarnings("boxing")
	public ThrowableToDoubleFunctionTest() {
		super(lambda -> lambda.applyAsDouble("1.5") == 1.5, Wrap::asToDoubleFunction, s -> {
