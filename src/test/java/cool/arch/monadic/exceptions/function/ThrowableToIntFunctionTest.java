...
public class ThrowableToIntFunctionTest extends
	AbstractLambdaTest<ThrowableToIntFunction<String>, ToIntFunction<String>> {

	@SuppressWarnings("boxing")
	public ThrowableToIntFunctionTest() {
		super(lambda -> lambda.applyAsInt("123") == 123, Wrap::asToIntFunction, s -> {
