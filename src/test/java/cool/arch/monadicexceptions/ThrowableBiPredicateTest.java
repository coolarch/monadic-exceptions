...
public class ThrowableBiPredicateTest extends
	AbstractLambdaTest<ThrowableBiPredicate<String, String>, BiPredicate<String, String>> {

	public ThrowableBiPredicateTest() {
		super(lambda -> {
			return lambda.test("foo", "foo");
		}, ThrowableBiPredicate::asBiPredicate, (t, u) -> {
