...
public class ThrowableIntToDoubleFunctionTest extends
	AbstractLambdaTest<ThrowableIntToDoubleFunction, IntToDoubleFunction> {

	public ThrowableIntToDoubleFunctionTest() {
		super(lambda -> {
			return lambda.applyAsDouble(3) == 3.0D;
		}, ThrowableIntToDoubleFunction::asIntToDoubleFunction, (l) -> {
